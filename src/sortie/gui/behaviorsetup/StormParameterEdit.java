...
import sortie.gui.ScheduledStormSetup;
import sortie.gui.components.OKCancelButtonPanel;
import sortie.gui.components.SortieFont;

/**
 * This class displays the dialog for editing Storm parameters, with a
 * button for scheduling storms.
 * @author LORA
 *
 */
public class StormParameterEdit extends JDialog 
   ...
   */
  public StormParameterEdit(JDialog jParent, GUIManager oManager, 
      MainWindow oWindow, Storm oBehavior) {
    ...
    //dialog to schedule storms
    JPanel jButtonPanel = new JPanel();
    jButtonPanel.setLayout(new BoxLayout(jButtonPanel, BoxLayout.Y_AXIS));
    JButton jButton = new JButton("Schedule storms...");
    jButton.setFont(new SortieFont());
    jButton.setActionCommand("ScheduleStorms");
    jButton.addActionListener(this);
    jButtonPanel.add(jButton, BorderLayout.SOUTH);
    ...
    jButtonPanel.add(jLabel, BorderLayout.NORTH);
    jButtonPanel.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
    
    QuickScrollingPanel jMainPanel = new QuickScrollingPanel();
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    else if (e.getActionCommand().equals("ScheduleStorms")) {
      ScheduledStormSetup oWindow = new ScheduledStormSetup(this, m_oManager);
      oWindow.pack();
