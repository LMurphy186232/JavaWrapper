...
public class DisperseBehaviors extends BehaviorTypeBase {
  ...
  public DisperseBehaviors(GUIManager oManager) throws ModelException {
    ...
    //Masting disperse with autocorrelation
    sXMLRootString = "MastingDisperseAutocorrelation";
    sParFileTag = "MastingDisperseAutocorrelation";
    sDescriptor = "Masting Disperse with Autocorrelation";
    mp_oAvailableBehaviors.add(new BehaviorInstantiator(MastingDisperseAutocorrelation.class, sDescriptor, sParFileTag, sXMLRootString));
