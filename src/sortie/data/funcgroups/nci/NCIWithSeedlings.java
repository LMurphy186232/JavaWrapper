 ...
 *
 */
public class NCIWithSeedlings extends Behavior {
  ...
  protected ModelVector mp_fNCIMinNeighborDBH = new ModelVector(
      "NCI Minimum Neighbor Diam10, in cm", "nciMinNeighborDBH",
  ...
  protected ModelFloat m_fNCIDbhDivisor = new ModelFloat(1,
      "NCI Diam10 Divisor (q)", "nciDbhDivisor");
   ...
   * Constructor.
   */
  public NCIWithSeedlings(GUIManager oManager, BehaviorTypeBase oParent, String sDescriptor) throws ModelException {
  ...
  public boolean setVectorValueByXMLTag(String sXMLTag, String sXMLParentTag,
    ...
    if (sXMLTag.equals("gr_juvNCIMaxCrowdingRadius")) {
      sXMLTag = "nciMaxCrowdingRadius";
    } else if (sXMLTag.equals("gr_juvNCIMinNeighborDiam10")) {
      sXMLTag = "nciMinNeighborDBH";
    } else if (sXMLTag.equals("gr_juvNCIAlpha")) {
      sXMLTag = "nciAlpha";
    } else if (sXMLTag.equals("gr_juvNCIBeta")) {
      sXMLTag = "nciBeta";
    }
    
    //Lambda
    else if (sXMLTag.startsWith("gr_juvNCI") && p_sChildXMLTags[0].equals("gr_jnlVal")) {
      sXMLTag = sXMLTag.replace("gr_juvNCI", "nci");
    }
  ...
  public boolean setSingleValueByXMLTag(String sXMLTag, String sXMLParentTag,
    ...
    if (sXMLTag.equals("gr_juvNCIDiam10Divisor")) {
      sXMLTag = "nciDbhDivisor";
    } else if (sXMLTag.equals("gr_juvNCIIncludeSnagsInNCI")) {
