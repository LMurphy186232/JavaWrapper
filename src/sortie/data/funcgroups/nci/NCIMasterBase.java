...
public class NCIMasterBase extends Behavior {
  ...
  public NCIMasterBase(GUIManager oManager, BehaviorTypeBase oParent, String sDescriptor, String sParFileTag, String sXMLRootString, String sHelpString) throws ModelException {
    ...
    mp_iPrecipEffects.add(new NCIEffect(PrecipitationEffectDoubleLocalDiff.class,
        "Double local diff. precip effect",
        NCIEffect.precipitation_effect.double_local_diff_precip_effect.ordinal()));
    ...
    mp_iTempEffects.add(new NCIEffect(TemperatureEffectDoubleLocalDiff.class,
        "Double local diff. temp. effect",
        NCIEffect.temperature_effect.double_local_diff_temp_effect.ordinal()));
