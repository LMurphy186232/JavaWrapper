 ...
 *
 */
public class NCITermNCIBARatio extends Behavior {
   ...
   * Constructor.
   */
  public NCITermNCIBARatio(GUIManager oManager, BehaviorTypeBase oParent, String sDescriptor) throws ModelException {
