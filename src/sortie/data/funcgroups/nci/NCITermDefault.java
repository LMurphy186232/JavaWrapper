 ...
 *
 */
public class NCITermDefault extends Behavior {
   ...
   * Constructor.
   */
  public NCITermDefault(GUIManager oManager, BehaviorTypeBase oParent, String sDescriptor) throws ModelException {
