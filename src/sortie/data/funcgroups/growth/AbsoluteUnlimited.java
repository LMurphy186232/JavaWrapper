 ...
 * @author lora
 */
public class AbsoluteUnlimited extends Behavior {
   ...
   */
  public AbsoluteUnlimited(GUIManager oManager, BehaviorTypeBase oParent, String sDescriptor, String sParFileTag, String sXMLRootString) throws ModelException {
