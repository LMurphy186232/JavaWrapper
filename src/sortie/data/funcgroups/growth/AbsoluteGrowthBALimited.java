 ...
 * @author lora
 */
public class AbsoluteGrowthBALimited extends Behavior {
   ...
   */
  public AbsoluteGrowthBALimited(GUIManager oManager, BehaviorTypeBase oParent, String sDescriptor, String sParFileTag, String sXMLRootString) throws ModelException {
    ...
    addRequiredData(m_iYrsExceedingThresholdBeforeSuppressed);
    ...
    //Data members
    mp_oNewTreeDataMembers.add(new DataMember("Years suppressed", "yls", 
        DataMember.INTEGER));
    mp_oNewTreeDataMembers.add(new DataMember("Years released", "ylr", 
        DataMember.INTEGER));
    mp_oNewTreeDataMembers.add(new DataMember("Diameter growth", "Growth", 
        DataMember.FLOAT));
  }
