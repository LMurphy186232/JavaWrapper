 ...
 * @author lora
 */
public class FuncResponseSeedPredationLnk extends Behavior {
   ...
   */
  public FuncResponseSeedPredationLnk(GUIManager oManager, BehaviorTypeBase oParent, String sDescriptor, String sParFileTag, String sXMLRootString) {
    super(oManager, oParent, sDescriptor, sParFileTag, sXMLRootString, "seed_predation_behaviors.functional_response_seed_predation_linked");
