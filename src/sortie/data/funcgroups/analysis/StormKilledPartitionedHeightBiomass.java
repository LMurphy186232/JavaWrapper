 ...
 * @author lora
 */
public class StormKilledPartitionedHeightBiomass extends Behavior {
   ...
   */
  public StormKilledPartitionedHeightBiomass(GUIManager oManager, BehaviorTypeBase oParent, String sDescriptor, String sParFileTag, String sXMLRootString) throws ModelException {
    super(oManager, oParent, sDescriptor, sParFileTag, sXMLRootString, "analysis_behaviors.storm_killed_partitioned_height_biomass");
