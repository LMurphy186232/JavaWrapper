 ...
 * N, P, etc) for all species. This requires the detailed output file 
 * to have data saved from the "Foliar Chemistry" grid.
 *
...
public class FoliarChemistryLineGraphDataRequest extends DataRequest {
   ...
   */
  public FoliarChemistryLineGraphDataRequest(String sChartName, 
    ...
    if (m_sDataMember.equals("p_")) m_sDataMember = "P_";
    if (m_sDataMember.equals("n_")) m_sDataMember = "N_";
    if (m_sDataMember.equals("sla_")) m_sDataMember = "SLA_";
    m_sDataMemberDisplay = sChartName.substring(
    		sChartName.indexOf(" - ") + 3) + "(kg/ha)";
  ...
  protected void writeChartDataToFile(FileWriter jOut) throws IOException, 
    ...
    jOut.write("Values in kg per hectare.\n");
