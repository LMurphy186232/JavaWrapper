...
* output file to have data saved from the "Storm Killed Partitioned Biomass"
* grid.
*
...
public class StormKilledPartitionedBiomassDataRequest extends DataRequest {
   ...
   */
  public StormKilledPartitionedBiomassDataRequest(String sChartName, DetailedOutputFileManager oManager) throws
      ModelException {
    super(sChartName, oManager);

    m_sThisGrid = "Storm Killed Partitioned Biomass";
