...
/**
 * Produces a line graph of Relative Neighborhood Density grid results. This
 * requires the detailed output file to have data saved from the "Relative
 * Neighborhood Density" grid.
 *
 ...
 * <br>Edit history:
 * <br>------------------
 * <br>September 19, 2007: Created (LEM)
 * <br>February 4, 2008: Updated to conform to Java 6 compliance (LEM)
 */

public class RelativeNeighborhoodDensityDataRequest extends DataRequest {
  ...
  /** The dataset values. The first index is number of species. The second 
   * index is number of increments.*/
   ...
   */
  public RelativeNeighborhoodDensityDataRequest(String sChartName, DetailedOutputFileManager oManager) throws
  ModelException {
    super(sChartName, oManager);

    m_sThisGrid = "Relative Neighborhood Density";
  ...
  private void setupDataset() {
    ...
    mp_fDatasetValues = new float[m_iNumSpecies][iNumIncs];
  ...
  ModelException {
    ...
    String sXAxisLabel = "Distance", sYAxisLabel = "Omega";
