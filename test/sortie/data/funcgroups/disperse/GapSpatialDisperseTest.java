...
public class GapSpatialDisperseTest extends ModelTestCase {
  ...
  public void testReadV6ParFile() {
    ...
    try {
      ...
      assertEquals(18.0, ((Float)oDisperse.mp_fMinDbhForReproduction.getValue().get(3)).floatValue(), 0.0001);
      assertEquals(19.0, ((Float)oDisperse.mp_fMinDbhForReproduction.getValue().get(4)).floatValue(), 0.0001);
      
      assertEquals(14.894, ((Float)oDisperse.mp_fSTR[W][G].getValue().get(3)).floatValue(), 0.0001);
      assertEquals(6.628, ((Float)oDisperse.mp_fSTR[W][G].getValue().get(4)).floatValue(), 0.0001);
      
      assertEquals(2.3, ((Float)oDisperse.mp_fBeta[W][G].getValue().get(3)).floatValue(), 0.0001);
      assertEquals(2.2, ((Float)oDisperse.mp_fBeta[W][G].getValue().get(4)).floatValue(), 0.0001);
      
      assertEquals(1.32E-4, ((Float)oDisperse.mp_fDispOrX0[W][G].getValue().get(3)).floatValue(), 0.0001);
      assertEquals(6.93E-6, ((Float)oDisperse.mp_fDispOrX0[W][G].getValue().get(4)).floatValue(), 0.0001);
      
      assertEquals(3.0, ((Float)oDisperse.mp_fThetaOrXb[W][G].getValue().get(3)).floatValue(), 0.0001);
      assertEquals(3.0, ((Float)oDisperse.mp_fThetaOrXb[W][G].getValue().get(4)).floatValue(), 0.0001);
      
      assertEquals(6.628, ((Float)oDisperse.mp_fSTR[L][C].getValue().get(3)).floatValue(), 0.0001);
      assertEquals(17.206, ((Float)oDisperse.mp_fSTR[L][C].getValue().get(4)).floatValue(), 0.0001);
      
      assertEquals(2.3, ((Float)oDisperse.mp_fBeta[L][C].getValue().get(3)).floatValue(), 0.0001);
      assertEquals(2.4, ((Float)oDisperse.mp_fBeta[L][C].getValue().get(4)).floatValue(), 0.0001);
      
      assertEquals(1.32E-4, ((Float)oDisperse.mp_fDispOrX0[L][C].getValue().get(3)).floatValue(), 0.0001);
      assertEquals(6.93E-6, ((Float)oDisperse.mp_fDispOrX0[L][C].getValue().get(4)).floatValue(), 0.0001);
      
      assertEquals(3.0, ((Float)oDisperse.mp_fThetaOrXb[L][C].getValue().get(3)).floatValue(), 0.0001);
      assertEquals(3.0, ((Float)oDisperse.mp_fThetaOrXb[L][C].getValue().get(4)).floatValue(), 0.0001);
      
      assertEquals(0, oDisperse.m_iMaxGapDensity.getValue());
      
      assertEquals(0, ((ModelEnum)oDisperse.mp_iWhichFunctionUsed[G].getValue().get(3)).getValue());
      assertEquals(0, ((ModelEnum)oDisperse.mp_iWhichFunctionUsed[G].getValue().get(4)).getValue());
      
      assertEquals(1, ((ModelEnum)oDisperse.mp_iWhichFunctionUsed[C].getValue().get(3)).getValue());
      assertEquals(1, ((ModelEnum)oDisperse.mp_iWhichFunctionUsed[C].getValue().get(4)).getValue());
  ...
  public void testValidateData() {
    try {
      ...
      try {
        ...
        if (oErr.getMessage().indexOf("Weibull Gap Beta") == -1)
          fail("Incorrect error. Message: " + oErr.getMessage());
      }
      finally {
        new File(sFileName).delete();
      ...
      try {
        ...
        if (oErr.getMessage().indexOf("Lognormal Gap Beta") == -1)
          fail("Incorrect error. Message: " + oErr.getMessage());
      }
      finally {
        new File(sFileName).delete();
  ...
  public void testCopySpecies() {
    ...
    try {
      ...
      assertEquals(((Float)oDisperse.mp_fSTR[WEIB][CAN].getValue().get(2)).floatValue(), 19.325, 0.001);

      assertEquals(((Float)oDisperse.mp_fSTR[WEIB][GAP].getValue().get(0)).floatValue(), 14.894, 0.001);
      assertEquals(((Float)oDisperse.mp_fSTR[WEIB][GAP].getValue().get(1)).floatValue(), 12.4, 0.001);
      assertEquals(((Float)oDisperse.mp_fSTR[WEIB][GAP].getValue().get(2)).floatValue(), 14.894, 0.001);
      ...
      assertEquals(((Float)oDisperse.mp_fSTR[LOGN][CAN].getValue().get(2)).floatValue(), 6.628, 0.001);

      assertEquals(((Float)oDisperse.mp_fSTR[LOGN][GAP].getValue().get(0)).floatValue(), 7.2, 0.001);
      assertEquals(((Float)oDisperse.mp_fSTR[LOGN][GAP].getValue().get(1)).floatValue(), 21.5, 0.001);
      assertEquals(((Float)oDisperse.mp_fSTR[LOGN][GAP].getValue().get(2)).floatValue(), 7.2, 0.001);
      ...
      assertEquals(((Float)oDisperse.mp_fBeta[WEIB][CAN].getValue().get(2)).floatValue(), 2.0, 0.001);
      
      assertEquals(((Float)oDisperse.mp_fBeta[WEIB][GAP].getValue().get(0)).floatValue(), 2.3, 0.001);
      assertEquals(((Float)oDisperse.mp_fBeta[WEIB][GAP].getValue().get(1)).floatValue(), 2.4, 0.001);
      assertEquals(((Float)oDisperse.mp_fBeta[WEIB][GAP].getValue().get(2)).floatValue(), 2.3, 0.001);
      ...
      assertEquals(((Float)oDisperse.mp_fBeta[LOGN][CAN].getValue().get(2)).floatValue(), 2.7, 0.001);
      
      assertEquals(((Float)oDisperse.mp_fBeta[LOGN][GAP].getValue().get(0)).floatValue(), 5.7, 0.001);
      assertEquals(((Float)oDisperse.mp_fBeta[LOGN][GAP].getValue().get(1)).floatValue(), 5.8, 0.001);
      assertEquals(((Float)oDisperse.mp_fBeta[LOGN][GAP].getValue().get(2)).floatValue(), 5.7, 0.001);
  ...
  public void testChangeOfSpecies() {
    ...
    try {
      ...
      assertEquals(((Float)oDisperse.mp_fSTR[WEIB][CAN].getValue().get(0)).floatValue(), 19.325, 0.001);
      assertEquals(((Float)oDisperse.mp_fSTR[WEIB][CAN].getValue().get(1)).floatValue(), 29.325, 0.001);
      assertEquals(((Float)oDisperse.mp_fSTR[WEIB][CAN].getValue().get(2)).floatValue(), 39.325, 0.001);

      assertEquals(((Float)oDisperse.mp_fSTR[WEIB][GAP].getValue().get(0)).floatValue(), 14.894, 0.001);
      assertEquals(((Float)oDisperse.mp_fSTR[WEIB][GAP].getValue().get(1)).floatValue(), 12.4, 0.001);
      assertEquals(((Float)oDisperse.mp_fSTR[WEIB][GAP].getValue().get(2)).floatValue(), 13.4, 0.001);

      assertEquals(((Float)oDisperse.mp_fSTR[LOGN][CAN].getValue().get(0)).floatValue(), 6.628, 0.001);
      assertEquals(((Float)oDisperse.mp_fSTR[LOGN][CAN].getValue().get(1)).floatValue(), 19.325, 0.001);
      assertEquals(((Float)oDisperse.mp_fSTR[LOGN][CAN].getValue().get(2)).floatValue(), 20.325, 0.001);

      assertEquals(((Float)oDisperse.mp_fSTR[LOGN][GAP].getValue().get(0)).floatValue(), 7.2, 0.001);
      assertEquals(((Float)oDisperse.mp_fSTR[LOGN][GAP].getValue().get(1)).floatValue(), 21.5, 0.001);
      assertEquals(((Float)oDisperse.mp_fSTR[LOGN][GAP].getValue().get(2)).floatValue(), 22.5, 0.001);
      ...
      assertEquals(((Float)oDisperse.mp_fBeta[WEIB][GAP].getValue().get(0)).floatValue(), 2.3, 0.001);
      assertEquals(((Float)oDisperse.mp_fBeta[WEIB][GAP].getValue().get(1)).floatValue(), 2.4, 0.001);
      assertEquals(((Float)oDisperse.mp_fBeta[WEIB][GAP].getValue().get(2)).floatValue(), 2.5, 0.001);
      ...
      assertEquals(((Float)oDisperse.mp_fBeta[LOGN][GAP].getValue().get(0)).floatValue(), 5.7, 0.001);
      assertEquals(((Float)oDisperse.mp_fBeta[LOGN][GAP].getValue().get(1)).floatValue(), 5.8, 0.001);
      assertEquals(((Float)oDisperse.mp_fBeta[LOGN][GAP].getValue().get(2)).floatValue(), 5.9, 0.001);
      ...
      assertEquals(((Float)oDisperse.mp_fSTR[WEIB][GAP].getValue().get(3)).floatValue(), 14.894, 0.001);
      assertEquals(((Float)oDisperse.mp_fSTR[WEIB][GAP].getValue().get(2)).floatValue(), 13.4, 0.001);

      assertEquals(((Float)oDisperse.mp_fSTR[LOGN][CAN].getValue().get(3)).floatValue(), 6.628, 0.001);
      assertEquals(((Float)oDisperse.mp_fSTR[LOGN][CAN].getValue().get(2)).floatValue(), 20.325, 0.001);

      assertEquals(((Float)oDisperse.mp_fSTR[LOGN][GAP].getValue().get(3)).floatValue(), 7.2, 0.001);
      assertEquals(((Float)oDisperse.mp_fSTR[LOGN][GAP].getValue().get(2)).floatValue(), 22.5, 0.001);
      
      assertEquals(((Float)oDisperse.mp_fBeta[WEIB][CAN].getValue().get(3)).floatValue(), 2.0, 0.001);
      assertEquals(((Float)oDisperse.mp_fBeta[WEIB][CAN].getValue().get(2)).floatValue(), 2.2, 0.001);
      
      assertEquals(((Float)oDisperse.mp_fBeta[WEIB][GAP].getValue().get(3)).floatValue(), 2.3, 0.001);
      assertEquals(((Float)oDisperse.mp_fBeta[WEIB][GAP].getValue().get(2)).floatValue(), 2.5, 0.001);
      
      assertEquals(((Float)oDisperse.mp_fBeta[LOGN][CAN].getValue().get(3)).floatValue(), 2.7, 0.001);
      assertEquals(((Float)oDisperse.mp_fBeta[LOGN][CAN].getValue().get(2)).floatValue(), 2.9, 0.001);
      
      assertEquals(((Float)oDisperse.mp_fBeta[LOGN][GAP].getValue().get(3)).floatValue(), 5.7, 0.001);
      assertEquals(((Float)oDisperse.mp_fBeta[LOGN][GAP].getValue().get(2)).floatValue(), 5.9, 0.001);
  ...
  public void testChangeOfSpecies2() {
    ...
    try {
      ...
      assertEquals(((Float)oDisperse.mp_fSTR[WEIB][CAN].getValue().get(0)).floatValue(), 29.325, 0.001);
      assertEquals(((Float)oDisperse.mp_fSTR[WEIB][CAN].getValue().get(1)).floatValue(), 39.325, 0.001);

      assertEquals(((Float)oDisperse.mp_fSTR[WEIB][GAP].getValue().get(0)).floatValue(), 12.4, 0.001);
      assertEquals(((Float)oDisperse.mp_fSTR[WEIB][GAP].getValue().get(1)).floatValue(), 13.4, 0.001);

      assertEquals(((Float)oDisperse.mp_fSTR[LOGN][CAN].getValue().get(0)).floatValue(), 19.325, 0.001);
      assertEquals(((Float)oDisperse.mp_fSTR[LOGN][CAN].getValue().get(1)).floatValue(), 20.325, 0.001);

      assertEquals(((Float)oDisperse.mp_fSTR[LOGN][GAP].getValue().get(0)).floatValue(), 21.5, 0.001);
      assertEquals(((Float)oDisperse.mp_fSTR[LOGN][GAP].getValue().get(1)).floatValue(), 22.5, 0.001);
      
      assertEquals(((Float)oDisperse.mp_fBeta[WEIB][CAN].getValue().get(0)).floatValue(), 2.1, 0.001);
      assertEquals(((Float)oDisperse.mp_fBeta[WEIB][CAN].getValue().get(1)).floatValue(), 2.2, 0.001);
      
      assertEquals(((Float)oDisperse.mp_fBeta[WEIB][GAP].getValue().get(0)).floatValue(), 2.4, 0.001);
      assertEquals(((Float)oDisperse.mp_fBeta[WEIB][GAP].getValue().get(1)).floatValue(), 2.5, 0.001);
      
      assertEquals(((Float)oDisperse.mp_fBeta[LOGN][CAN].getValue().get(0)).floatValue(), 2.8, 0.001);
      assertEquals(((Float)oDisperse.mp_fBeta[LOGN][CAN].getValue().get(1)).floatValue(), 2.9, 0.001);
      
      assertEquals(((Float)oDisperse.mp_fBeta[LOGN][GAP].getValue().get(0)).floatValue(), 5.8, 0.001);
      assertEquals(((Float)oDisperse.mp_fBeta[LOGN][GAP].getValue().get(1)).floatValue(), 5.9, 0.001);
  ...
  private String writeDisperseXMLFile() throws java.io.IOException {
    ...
    oOut.write("<di_lgsVal species=\"Species_1\">7.2</di_lgsVal>");
    oOut.write("<di_lgsVal species=\"Species_2\">21.5</di_lgsVal>");
    oOut.write("<di_lgsVal species=\"Species_3\">22.5</di_lgsVal>");
    oOut.write("</di_lognormalGapSTR>");
    oOut.write("<di_lognormalGapBeta>");
    oOut.write("<di_lgbVal species=\"Species_1\">5.7</di_lgbVal>");
    oOut.write("<di_lgbVal species=\"Species_2\">5.8</di_lgbVal>");
    oOut.write("<di_lgbVal species=\"Species_3\">5.9</di_lgbVal>");
    oOut.write("</di_lognormalGapBeta>");
