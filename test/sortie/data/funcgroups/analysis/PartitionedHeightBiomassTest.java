...
public class PartitionedHeightBiomassTest extends ModelTestCase {
  ...
  public void testReadV6ParFile() {
    ...
    try {
      ...
      ArrayList<Behavior> p_oBios = oAnalysis.getBehaviorByParameterFileTag("PartitionedHeightBiomass");
      assertEquals(1, p_oBios.size());
      PartitionedHeightBiomass oBio = (PartitionedHeightBiomass) p_oBios.get(0);
      ...
      assertEquals(-21.6, ((Float) oBio.mp_fPartBioHeightBoleB.getValue().get(4)).floatValue(), 0.0001);      
    }
    catch (ModelException oErr) {
  ...
  public void testFormatDataForDisplay() {
    ...
    try {
      ...
      AnalysisBehaviors oAnalysis = oManager.getAnalysisBehaviors();
      String[] p_sExpected;
      PartitionedHeightBiomass oBeh = (PartitionedHeightBiomass) 
          oAnalysis.createBehaviorFromParameterFileTag("PartitionedHeightBiomass");
  ...
  public void testReadPartitionedBiomassSettings() {
    ...
    try {
      ...
      assertEquals("Mg Leaf Biomass for Species 3", oGrid.getDataMembers()[2].getDisplayName());
      assertEquals("Mg Bole Biomass for Species 1", oGrid.getDataMembers()[3].getDisplayName());
      assertEquals("Mg Bole Biomass for Species 2", oGrid.getDataMembers()[4].getDisplayName());
      assertEquals("Mg Bole Biomass for Species 3", oGrid.getDataMembers()[5].getDisplayName());
      assertEquals("Mg Branch Biomass for Species 1", oGrid.getDataMembers()[6].getDisplayName());
      assertEquals("Mg Branch Biomass for Species 2", oGrid.getDataMembers()[7].getDisplayName());
      assertEquals("Mg Branch Biomass for Species 3", oGrid.getDataMembers()[8].getDisplayName());
      assertEquals("Mg Leaf Height Biomass for Species 1", oGrid.getDataMembers()[9].getDisplayName());
      assertEquals("Mg Leaf Height Biomass for Species 2", oGrid.getDataMembers()[10].getDisplayName());
      assertEquals("Mg Leaf Height Biomass for Species 3", oGrid.getDataMembers()[11].getDisplayName());
      assertEquals("Mg Bole Height Biomass for Species 1", oGrid.getDataMembers()[12].getDisplayName());
      assertEquals("Mg Bole Height Biomass for Species 2", oGrid.getDataMembers()[13].getDisplayName());
      assertEquals("Mg Bole Height Biomass for Species 3", oGrid.getDataMembers()[14].getDisplayName());
  ...
  public void testChangeOfSpecies() {
    ...
    try {
      ...
      p_oBios = oAnalysis.getBehaviorByParameterFileTag("PartitionedHeightBiomass");
      assertEquals(1, p_oBios.size());
      oBio = (PartitionedHeightBiomass) p_oBios.get(0);
  ...
  private String writeXMLFileForGridTest() throws IOException {
    ...
    oOut.write("<PartitionedBiomass2>");
    oOut.write("<an_partBioDbhLeafA>");
    oOut.write("<an_pbdlaVal species=\"Species_1\">1.792</an_pbdlaVal>");
    oOut.write("<an_pbdlaVal species=\"Species_2\">1.449</an_pbdlaVal>");
    oOut.write("</an_partBioDbhLeafA>");
    oOut.write("<an_partBioDbhLeafB>");
    oOut.write("<an_pbdlbVal species=\"Species_1\">3.758</an_pbdlbVal>");
    oOut.write("<an_pbdlbVal species=\"Species_2\">3.37</an_pbdlbVal>");
    oOut.write("</an_partBioDbhLeafB>");
    oOut.write("<an_partBioDbhBranchA>");
    oOut.write("<an_pbdbraVal species=\"Species_1\">1.982</an_pbdbraVal>");
    oOut.write("<an_pbdbraVal species=\"Species_2\">1.786</an_pbdbraVal>");
    oOut.write("</an_partBioDbhBranchA>");
    oOut.write("<an_partBioDbhBranchB>");
    oOut.write("<an_pbdbrbVal species=\"Species_1\">3.69</an_pbdbrbVal>");
    oOut.write("<an_pbdbrbVal species=\"Species_2\">3.504</an_pbdbrbVal>");
    oOut.write("</an_partBioDbhBranchB>");
    oOut.write("<an_partBioDbhBoleA>");
    oOut.write("<an_pbdboaVal species=\"Species_1\">2.559</an_pbdboaVal>");
    oOut.write("<an_pbdboaVal species=\"Species_2\">1.471</an_pbdboaVal>");
    oOut.write("</an_partBioDbhBoleA>");
    oOut.write("<an_partBioDbhBoleB>");
    oOut.write("<an_pbdbobVal species=\"Species_1\">2.832</an_pbdbobVal>");
    oOut.write("<an_pbdbobVal species=\"Species_2\">0.779</an_pbdbobVal>");
    oOut.write("</an_partBioDbhBoleB>");
    oOut.write("</PartitionedBiomass2>");
    oOut.write("</paramFile>");
  ...
  private String write6XMLValidFile() throws IOException {
    ...
    oOut.write("<an_pbhbobVal species=\"Species_5\">-21.6</an_pbhbobVal>");
    oOut.write("</an_partBioHeightBoleB>");
    oOut.write("</analysis>");
    oOut.write("</paramFile>");
