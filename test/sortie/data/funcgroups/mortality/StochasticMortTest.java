...
public class StochasticMortTest extends TestCase {
  ...
  public void testReadV6ParFile() {
    ...
    try {
      ...
      ArrayList<Behavior> p_oBehs = oMortBeh.getBehaviorByParameterFileTag("StochasticMortality");
      assertEquals(2, p_oBehs.size());

      StochasticMort oMort = (StochasticMort) p_oBehs.get(0);
      assertEquals(0, ((Float)oMort.mp_fRandomMortality.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(1, ((Float)oMort.mp_fRandomMortality.getValue().get(3)).floatValue(), 0.0001);
      assertEquals(0.25, ((Float)oMort.mp_fRandomMortality.getValue().get(2)).floatValue(), 0.0001);
      
      oMort = (StochasticMort) p_oBehs.get(1);
      assertEquals(0.3, ((Float)oMort.mp_fRandomMortality.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(0.9, ((Float)oMort.mp_fRandomMortality.getValue().get(3)).floatValue(), 0.0001);
      assertEquals(0.2, ((Float)oMort.mp_fRandomMortality.getValue().get(2)).floatValue(), 0.0001);
  ...
  public void testReadParFile() {
    ...
    try {
      ...
      StochasticMort oMort = (StochasticMort) p_oBehs.get(0);
      assertEquals(0.5, ((Float)oMort.mp_fRandomMortality.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(1.0, ((Float)oMort.mp_fRandomMortality.getValue().get(2)).floatValue(), 0.0001);
      
      oMort = (StochasticMort) p_oBehs.get(1);
      assertEquals(0.3, ((Float)oMort.mp_fRandomMortality.getValue().get(2)).floatValue(), 0.0001);
      assertEquals(0.0, ((Float)oMort.mp_fRandomMortality.getValue().get(3)).floatValue(), 0.0001);
  ...
  private String writeValidXMLFile() throws java.io.IOException {
    ...
    oOut.write("<mo_smrVal species=\"Species_3\">0.3</mo_smrVal>");
    oOut.write("<mo_smrVal species=\"Species_4\">0.0</mo_smrVal>");
    oOut.write("</mo_stochasticMortRate>");
    oOut.write("</StochasticMortality3>");
    oOut.write("<StochasticMortality2>");
    oOut.write("<mo_stochasticMortRate>");
    oOut.write("<mo_smrVal species=\"Species_1\">0.5</mo_smrVal>");
    oOut.write("<mo_smrVal species=\"Species_3\">1.0</mo_smrVal>");
    oOut.write("</mo_stochasticMortRate>");
    oOut.write("</StochasticMortality2>");
  ...
  private String write6XMLValidFile() throws IOException {
    ...
    oOut.write("<plot_title>Test Plot 2</plot_title>");
    oOut.write("</plot>");
    oOut.write("<trees>");
    oOut.write("<tr_speciesList>");
    oOut.write("<tr_species speciesName=\"Species_1\"/>");
    ...
    oOut.write("<mo_nsdmVal species=\"Species_4\">1</mo_nsdmVal>");
    oOut.write("<mo_nsdmVal species=\"Species_3\">0.25</mo_nsdmVal>");
    oOut.write("</mo_nonSizeDepMort>");
    oOut.write("<mo_randomJuvenileMortality>");
    oOut.write("<mo_rjmVal species=\"Species_1\">0.3</mo_rjmVal>");
    oOut.write("<mo_rjmVal species=\"Species_4\">0.9</mo_rjmVal>");
    oOut.write("<mo_rjmVal species=\"Species_3\">0.2</mo_rjmVal>");
    oOut.write("</mo_randomJuvenileMortality>");
    oOut.write("</mortality>");
    oOut.write("</paramFile>");
