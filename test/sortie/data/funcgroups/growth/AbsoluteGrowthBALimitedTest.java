...
public class AbsoluteGrowthBALimitedTest extends ModelTestCase {
  ...
  public void testReadV6ParFile() {
    ...
    try {
      ...
      ArrayList<Behavior> p_oBehs = oGrowthBeh.getBehaviorByParameterFileTag("AbsBAGrowth");
      assertEquals(1, p_oBehs.size());
      AbsoluteGrowthBALimited oGrowth = (AbsoluteGrowthBALimited) p_oBehs.get(0);
      ...
      assertEquals(1.2, ((Float)oGrowth.mp_fAdultConstantAreaInc.getValue().get(1)).floatValue(), 0.0001);
  ...
  public void testReadV6ParFileDiamOnly() {
    ...
    try {
      ...
      oManager.inputXMLParameterFile(sNewFileName);
      GrowthBehaviors oGrowthBeh = oManager.getGrowthBehaviors();
      ArrayList<Behavior> p_oBehs = oGrowthBeh.getBehaviorByParameterFileTag("AbsBAGrowth diam only");
      assertEquals(1, p_oBehs.size());
      AbsoluteGrowthBALimited oGrowth = (AbsoluteGrowthBALimited) p_oBehs.get(0);
      ...
      assertEquals(1.3, ((Float)oGrowth.mp_fAdultConstantAreaInc.getValue().get(2)).floatValue(), 0.0001);
  ...
  public void testValidateDataDiamOnly() {
    ...
    try {
      ...
      p_oBehs = oGrowthBeh.getBehaviorByParameterFileTag("AbsBAGrowth diam only");
      assertEquals(1, p_oBehs.size());
      oGrowth = (AbsoluteGrowthBALimited) p_oBehs.get(0);
  ...
  public void testReadParFileDiamOnly() {
    ...
    try {
      ...
      assertEquals(0.3, ((Float)oGrowth.mp_fAdultConstantAreaInc.getValue().get(2)).floatValue(), 0.0001);
  ...
  public void testValidateData() {
    ...
    try {
      ...
      oManager.inputXMLParameterFile(sFileName);
      oGrowthBeh = oManager.getGrowthBehaviors();
      p_oBehs = oGrowthBeh.getBehaviorByParameterFileTag("AbsBAGrowth");
      assertEquals(1, p_oBehs.size());
      oGrowth = (AbsoluteGrowthBALimited) p_oBehs.get(0);
      oGrowth.m_iYrsExceedingThresholdBeforeSuppressed.setValue(-4);
      try {
  ...
  public void testReadParFile() {
    ...
    try {
      ...
      assertEquals(0.2, ((Float)oGrowth.mp_fAdultConstantAreaInc.getValue().get(1)).floatValue(), 0.0001);
  ...
  private String writeXMLValidFile1() throws java.io.IOException {
    ...
    oOut.write("</gr_slopeGrowthResponse>");
    oOut.write("<gr_lengthLastSuppFactor>");
    oOut.write("<gr_llsfVal species=\"Species_2\">0.0</gr_llsfVal>");
    oOut.write("</gr_lengthLastSuppFactor>");
    oOut.write("<gr_lengthCurrReleaseFactor>");
    oOut.write("<gr_lcrfVal species=\"Species_2\">0.0</gr_lcrfVal>");
    oOut.write("</gr_lengthCurrReleaseFactor>");
    oOut.write("<gr_yrsExceedThresholdBeforeSupp>6</gr_yrsExceedThresholdBeforeSupp>");
    oOut.write("<gr_mortRateAtSuppression>0.1</gr_mortRateAtSuppression>");
    oOut.write("</AbsUnlimGrowth5>");
