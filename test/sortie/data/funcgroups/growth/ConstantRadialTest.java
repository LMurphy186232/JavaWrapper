...
public class ConstantRadialTest extends TestCase {
  ...
  public void testReadParFileDiamOnly() {
    ...
    try {
      ...
      ArrayList<Behavior> p_oBehs = oGrowthBeh.getBehaviorByParameterFileTag("ConstRadialGrowth diam only");
      assertEquals(1, p_oBehs.size());
      ConstantRadial oGrowth = (ConstantRadial) p_oBehs.get(0);

      assertEquals(0.2, ((Float)oGrowth.mp_fAdultConstantRadialGrowth.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(0.799, ((Float)oGrowth.mp_fAdultConstantRadialGrowth.getValue().get(1)).floatValue(), 0.0001);
  ...
  public void testReadParFile() {
    ...
    try {
      ...
      oManager.inputXMLParameterFile(sFileName);
      GrowthBehaviors oGrowthBeh = oManager.getGrowthBehaviors();
      ArrayList<Behavior> p_oBehs = oGrowthBeh.getBehaviorByParameterFileTag("ConstRadialGrowth");
      assertEquals(1, p_oBehs.size());
      ConstantRadial oGrowth = (ConstantRadial) p_oBehs.get(0);
  ...
  private String writeXMLValidFile1(boolean bDiamOnly) throws IOException {
    ...
    oOut.write("</behavior>");
    oOut.write("<behavior>");
    oOut.write("<behaviorName>ConstRadialGrowth"); if (bDiamOnly) oOut.write(" diam only"); oOut.write("</behaviorName>");
    oOut.write("<version>1</version>");
    ...
    oOut.write("<gr_acriVal species=\"Species_1\">0.2</gr_acriVal>");
    oOut.write("<gr_acriVal species=\"Species_2\">0.799</gr_acriVal>");
    oOut.write("</gr_adultConstRadialInc>");
    oOut.write("</ConstRadialGrowth2>");
