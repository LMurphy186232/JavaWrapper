...
public class TemperatureEffectWeibullTest extends TestCase {
  ...
  public void testParFileRead() {
    ...
    try {
      ...
      assertEquals(6.884225, ((Float) oTempEffect.mp_fTempA.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(139.5745, ((Float) oTempEffect.mp_fTempA.getValue().get(1)).floatValue(), 0.0001);

      assertEquals(0.3014869, ((Float) oTempEffect.mp_fTempB.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(0, ((Float) oTempEffect.mp_fTempB.getValue().get(1)).floatValue(), 0.0001);

      assertEquals(14.2357, ((Float) oTempEffect.mp_fTempC.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(28.6192, ((Float) oTempEffect.mp_fTempC.getValue().get(1)).floatValue(), 0.0001);
      
      oGrowth = (NCIMasterGrowth) p_oBehs.get(1);
      assertTrue(oGrowth.mp_oEffects.get(4) instanceof TemperatureEffectWeibull);
      oTempEffect = (TemperatureEffectWeibull) oGrowth.mp_oEffects.get(4);
      
      assertEquals(8.897617, ((Float) oTempEffect.mp_fTempA.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(8.91133, ((Float) oTempEffect.mp_fTempA.getValue().get(1)).floatValue(), 0.0001);

      assertEquals(1.205544, ((Float) oTempEffect.mp_fTempB.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(1.475192, ((Float) oTempEffect.mp_fTempB.getValue().get(1)).floatValue(), 0.0001);

      assertEquals(13.2644, ((Float) oTempEffect.mp_fTempC.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(12.4024, ((Float) oTempEffect.mp_fTempC.getValue().get(1)).floatValue(), 0.0001);
