...
public class DefaultSizeEffectTest extends TestCase {
  ...
  public void testCopySpecies() {
    ...
    try {
      ...
      assertEquals(4, oSizeEffect.getNumberOfCombos());
      for (i = 0; i < oSizeEffect.getNumberOfCombos(); i++) {
        oCombo = oSizeEffect.getSpeciesTypeCombo(i);
        assertEquals(3, oCombo.getType());
        assertEquals(i, oCombo.getSpecies());
      }
      ...
      assertEquals(44.24, ((Float) oSizeEffect.mp_fNCISizeEffectX0.getValue().get(2)).floatValue(), 0.0001);
      assertEquals(22.23, ((Float) oSizeEffect.mp_fNCISizeEffectX0.getValue().get(3)).floatValue(), 0.0001);
      ...
      assertEquals(6, ((Float) oSizeEffect.mp_fNCISizeEffectXb.getValue().get(2)).floatValue(), 0.0001);
      assertEquals(3.36, ((Float) oSizeEffect.mp_fNCISizeEffectXb.getValue().get(3)).floatValue(), 0.0001);
      ...
      oSizeEffect = (SizeEffectDefault) oMaster.mp_oEffects.get(0);
      assertEquals(5, oSizeEffect.getNumberOfCombos());
      for (i = 0; i < oSizeEffect.getNumberOfCombos() - 1; i++) {
        oCombo = oSizeEffect.getSpeciesTypeCombo(i);
        assertEquals(3, oCombo.getType());
        assertEquals(i, oCombo.getSpecies());
      }
      oCombo = oSizeEffect.getSpeciesTypeCombo(4);
      assertEquals(3, oCombo.getType());
      assertEquals(7, oCombo.getSpecies());
      ...
      assertEquals(44.24, ((Float) oSizeEffect.mp_fNCISizeEffectX0.getValue().get(2)).floatValue(), 0.0001);
      assertEquals(22.23, ((Float) oSizeEffect.mp_fNCISizeEffectX0.getValue().get(3)).floatValue(), 0.0001);
      assertEquals(12.23, ((Float) oSizeEffect.mp_fNCISizeEffectX0.getValue().get(7)).floatValue(), 0.0001);
      
      assertEquals(5, ((Float) oSizeEffect.mp_fNCISizeEffectXb.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(2.36, ((Float) oSizeEffect.mp_fNCISizeEffectXb.getValue().get(1)).floatValue(), 0.0001);
      assertEquals(6, ((Float) oSizeEffect.mp_fNCISizeEffectXb.getValue().get(2)).floatValue(), 0.0001);
      assertEquals(3.36, ((Float) oSizeEffect.mp_fNCISizeEffectXb.getValue().get(3)).floatValue(), 0.0001);
      assertEquals(2.36, ((Float) oSizeEffect.mp_fNCISizeEffectXb.getValue().get(7)).floatValue(), 0.0001);
  ...
  public void testChangeOfSpecies() {
    ...
    try {
     ...
     String[] sNewSpecies = new String[] {
      ...
      assertEquals(122.23, ((Float) oSizeEffect.mp_fNCISizeEffectX0.getValue().get(0)).floatValue(), 0.0001);
      
      assertEquals(2.36, ((Float) oSizeEffect.mp_fNCISizeEffectXb.getValue().get(0)).floatValue(), 0.0001);    
