...
public class PrecipitationEffectWeibullTest extends TestCase {
  ...
  public void testParFileRead() {
    ...
    try {
      ...
      assertEquals(1296.228, ((Float) oPrecipEffect.mp_fPrecipA.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(3306.159, ((Float) oPrecipEffect.mp_fPrecipA.getValue().get(1)).floatValue(), 0.0001);

      assertEquals(0.8027915, ((Float) oPrecipEffect.mp_fPrecipB.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(6.669916, ((Float) oPrecipEffect.mp_fPrecipB.getValue().get(1)).floatValue(), 0.0001);

      assertEquals(1032.264, ((Float) oPrecipEffect.mp_fPrecipC.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(3835.918, ((Float) oPrecipEffect.mp_fPrecipC.getValue().get(1)).floatValue(), 0.0001);
      
      assertEquals(1, oPrecipEffect.m_iPrecipType.getValue());
      
      oGrowth = (NCIMasterGrowth) p_oBehs.get(1);
      assertTrue(oGrowth.mp_oEffects.get(3) instanceof PrecipitationEffectWeibull);
      oPrecipEffect = (PrecipitationEffectWeibull) oGrowth.mp_oEffects.get(3);
      
      assertEquals(420.2115, ((Float) oPrecipEffect.mp_fPrecipA.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(3.753555, ((Float) oPrecipEffect.mp_fPrecipA.getValue().get(1)).floatValue(), 0.0001);

      assertEquals(0.4447052, ((Float) oPrecipEffect.mp_fPrecipB.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(0.07809054, ((Float) oPrecipEffect.mp_fPrecipB.getValue().get(1)).floatValue(), 0.0001);

      assertEquals(0.000319117, ((Float) oPrecipEffect.mp_fPrecipC.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(1048.734, ((Float) oPrecipEffect.mp_fPrecipC.getValue().get(1)).floatValue(), 0.0001);
  ...
  private String writeXMLValidFile1(boolean bDiamOnly) throws IOException {
    ...
    oOut.write("</nciWeibPrecipEffC>");
    oOut.write("<nciWeibPrecipType>1</nciWeibPrecipType>");
