...
import sortie.data.funcgroups.nci.NCIWithSeedlings;
...
public class NCIWithSeedlingsTest extends TestCase {
  ...
  public void testCopySpecies() {
    ...
    try {
      ...
      assertTrue(oMaster.mp_oEffects.get(1) instanceof NCIWithSeedlings);
      NCIWithSeedlings oNCITerm = (NCIWithSeedlings) oMaster.mp_oEffects.get(1);      
      ...
      oNCITerm = (NCIWithSeedlings) oMaster.mp_oEffects.get(1);
  ...
  public void testValidateData() {
    ...
    try {
      ...
      oManager.getGrowthBehaviors().validateData(oManager.getTreePopulation());
      fail("Parameter file read failed to catch min neighbor diam.");
    }
    catch (ModelException oErr) {
      ;
    }
  ...
  private String writeXMLValidFile1(boolean bDiamOnly) throws IOException {
    ...
    oOut.write("<nciWhichNCITerm>5</nciWhichNCITerm>");
