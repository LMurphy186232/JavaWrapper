...
public class NCITermDefaultTest extends TestCase {
  ...
  public void testCopySpecies() {
    ...
    try {
      ...
      assertTrue(oMaster.mp_oEffects.get(1) instanceof NCITermDefault);
      NCITermDefault oNCITerm = (NCITermDefault) oMaster.mp_oEffects.get(1);      
      ...
      oNCITerm = (NCITermDefault) oMaster.mp_oEffects.get(1);
