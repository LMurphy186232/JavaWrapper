...
public class NCITermBARatioTest extends TestCase {
  ...
  public void testChangeOfSpecies() {
    ...
    try {
      ...
      assertTrue(oGrowth.mp_oEffects.get(1) instanceof NCITermNCIBARatio);
      NCITermNCIBARatio oNCITerm = (NCITermNCIBARatio) oGrowth.mp_oEffects.get(1);
  ...
  public void testCopySpecies() {
    ...
    try {
      ...
      oNCITerm = (NCITermNCIBARatio) oMaster.mp_oEffects.get(1);
  ...
  private String writeXMLValidFile1(boolean bDiamOnly) throws IOException {
    ...
    oOut.write("<nciWhichNCITerm>" + NCIEffect.nci_term.nci_nci_ba_ratio.ordinal() + "</nciWhichNCITerm>");
