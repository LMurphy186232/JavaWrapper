...
public class PrecipitationEffectDoubleLogisticTest extends TestCase {
  ...
  public void testParFileRead() {
    ...
    try {
      ...
      assertTrue(oGrowth.mp_oEffects.get(0) instanceof PrecipitationEffectDoubleLogistic);
      PrecipitationEffectDoubleLogistic oPrecipEffect = (PrecipitationEffectDoubleLogistic) oGrowth.mp_oEffects.get(0);
      
      assertEquals(0.35, ((Float) oPrecipEffect.mp_fAl.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(0.4, ((Float) oPrecipEffect.mp_fAl.getValue().get(1)).floatValue(), 0.0001);

      assertEquals(700, ((Float) oPrecipEffect.mp_fBl.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(600, ((Float) oPrecipEffect.mp_fBl.getValue().get(1)).floatValue(), 0.0001);

      assertEquals(4, ((Float) oPrecipEffect.mp_fCl.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(3, ((Float) oPrecipEffect.mp_fCl.getValue().get(1)).floatValue(), 0.0001);

      assertEquals(0.6, ((Float) oPrecipEffect.mp_fAh.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(0.66, ((Float) oPrecipEffect.mp_fAh.getValue().get(1)).floatValue(), 0.0001);

      assertEquals(475, ((Float) oPrecipEffect.mp_fBh.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(542, ((Float) oPrecipEffect.mp_fBh.getValue().get(1)).floatValue(), 0.0001);

      assertEquals(7, ((Float) oPrecipEffect.mp_fCh.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(0.2, ((Float) oPrecipEffect.mp_fCh.getValue().get(1)).floatValue(), 0.0001);
  ...
  private String writeXMLValidFile1(boolean bDiamOnly) throws IOException {
    ...
    oOut.write("</nciDoubLogPrecipEffCh>");
    oOut.write("<nciDoubleLogisticPrecipType>1</nciDoubleLogisticPrecipType>");
