...
public class NCITermNCITempDepBARatioDBHDefaultTest extends TestCase {
  ...
  public void testChangeOfSpecies() {
    ...
    try {
      ...
      assertTrue(oGrowth.mp_oEffects.get(1) instanceof NCITermNCITempDepBARatioDBHDefault);
      NCITermNCITempDepBARatioDBHDefault oNCITerm = (NCITermNCITempDepBARatioDBHDefault) oGrowth.mp_oEffects.get(1);
  ...
  public void testCopySpecies() {
    ...
    try {
      ...
      oNCITerm = (NCITermNCITempDepBARatioDBHDefault) oMaster.mp_oEffects.get(1);
  ...
  private String writeXMLValidFile1(boolean bDiamOnly) throws IOException {
    ...
    oOut.write("<nciWhichNCITerm>" + NCIEffect.nci_term.nci_nci_temp_dep_ba_ratio_ba_default.ordinal() + "</nciWhichNCITerm>");
