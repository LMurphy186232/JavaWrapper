...
public class NCITermBARatioDBHDefaultTest extends TestCase {
  ...
  public void testChangeOfSpecies() {
    ...
    try {
      ...
      assertTrue(oGrowth.mp_oEffects.get(1) instanceof NCITermNCIBARatioDBHDefault);
      NCITermNCIBARatioDBHDefault oNCITerm = (NCITermNCIBARatioDBHDefault) oGrowth.mp_oEffects.get(1);
      
      assertEquals(10, oNCITerm.m_fMaxAdultRadius.getValue(), 0.0001);
      assertEquals(5, oNCITerm.m_fMaxSaplingRadius.getValue(), 0.0001);
      assertEquals(1, oNCITerm.m_fDefaultDBH.getValue(), 0.0001);
      ...
      assertEquals(11, ((Float) oNCITerm.mp_fNCIMinNeighborDBH.getValue().get(1)).floatValue(), 0.0001);
      ...
      assertEquals(0.99, ((Float) oVector.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(0.65, ((Float) oVector.getValue().get(1)).floatValue(), 0.0001);
     ...
     String[] sNewSpecies = new String[] {
      ...
      assertEquals(11, ((Float) oNCITerm.mp_fNCIMinNeighborDBH.getValue().get(0)).floatValue(), 0.0001);
  ...
  public void testCopySpecies() {
    ...
    try {
      ...
      assertTrue(oMaster.mp_oEffects.get(1) instanceof NCITermNCIBARatioDBHDefault);
      NCITermNCIBARatioDBHDefault oNCITerm = (NCITermNCIBARatioDBHDefault) oMaster.mp_oEffects.get(1);      
      ...
      oNCITerm = (NCITermNCIBARatioDBHDefault) oMaster.mp_oEffects.get(1);
  ...
  public void testValidateData() {
    ...
    try {
      ...
      assertTrue(oMaster.mp_oEffects.get(1) instanceof NCITermNCIBARatioDBHDefault);
      NCITermNCIBARatioDBHDefault oNCITerm = (NCITermNCIBARatioDBHDefault) oMaster.mp_oEffects.get(1);
      oNCITerm.m_fDefaultDBH.setValue(-20);
      oManager.getGrowthBehaviors().validateData(oManager.getTreePopulation());
      fail("Parameter file read failed to catch bad NCI default DBH value.");
    }
    catch (ModelException oErr) {
      ;
    }
  ...
  private String writeXMLValidFile1(boolean bDiamOnly) throws IOException {
    ...
    oOut.write("<nciWhichNCITerm>" + NCIEffect.nci_term.nci_nci_ba_ratio_ba_default.ordinal() + "</nciWhichNCITerm>");
    ...
    oOut.write("<nciMaxSaplingCrowdingRadius>5</nciMaxSaplingCrowdingRadius>");
    oOut.write("<nciDbhAdjustor>2</nciDbhAdjustor>");
    oOut.write("<nciBADefaultDBH>1</nciBADefaultDBH>");
    ...
    oOut.write("<nlVal species=\"Species_1\">0.87</nlVal>");
    oOut.write("<nlVal species=\"Species_2\">0.3</nlVal>");
    oOut.write("</nciSpecies_1NeighborLambda>");
    oOut.write("<nciSpecies_2NeighborLambda>");
    oOut.write("<nlVal species=\"Species_1\">0.99</nlVal>");
    oOut.write("<nlVal species=\"Species_2\">0.65</nlVal>");
    oOut.write("</nciSpecies_2NeighborLambda>");
    oOut.write("<nciMinNeighborDBH>");
    oOut.write("<nmndVal species=\"Species_1\">10</nmndVal>");
    oOut.write("<nmndVal species=\"Species_2\">11</nmndVal>");
    oOut.write("</nciMinNeighborDBH>");
    oOut.write("</NCIMasterGrowth1>");
