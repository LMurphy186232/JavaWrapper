...
public class SizeEffectLowerBoundedTest extends TestCase {
  ...
  public void testParFileRead() {
    ...
    try {
      ...
      assertTrue(oGrowth.mp_oEffects.get(2) instanceof SizeEffectLowerBounded);
      oSizeEffect = (SizeEffectLowerBounded) oGrowth.mp_oEffects.get(2);
      
      assertEquals(397.615, ((Double) oSizeEffect.mp_fSizeEffectX0.getValue().get(0)).doubleValue(), 0.0001);
      assertEquals(28.07, ((Double) oSizeEffect.mp_fSizeEffectX0.getValue().get(1)).doubleValue(), 0.0001);

      assertEquals(5.065, ((Float) oSizeEffect.mp_fSizeEffectXb.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(1.902, ((Float) oSizeEffect.mp_fSizeEffectXb.getValue().get(1)).floatValue(), 0.0001);
      
      assertEquals(3.54, ((Float) oSizeEffect.mp_fSizeEffectMinDBH.getValue().get(0)).floatValue(), 0.0001);
      assertEquals(8, ((Float) oSizeEffect.mp_fSizeEffectMinDBH.getValue().get(1)).floatValue(), 0.0001);
