...
public class TemperatureClimateChangeTest extends TestCase {
  ...
  public void testReadV6ParFile() {
    ...
    try {
      ...
      ArrayList<Behavior> p_oBehs = oStateBeh.getBehaviorByParameterFileTag("TemperatureClimateChange");
      assertEquals(1, p_oBehs.size());
      TemperatureClimateChange oState = (TemperatureClimateChange) p_oBehs.get(0);

      assertEquals(0.02, oState.m_fClimateChangeTempB.getValue(), 0.0001);
      assertEquals(1, oState.m_fClimateChangeTempC.getValue(), 0.0001);
      assertEquals(0, oState.m_fClimateChangeMinTemp.getValue(), 0.0001);
      assertEquals(10, oState.m_fClimateChangeMaxTemp.getValue(), 0.0001);          
    }
  ...
  public void testReadParFile() {
    ...
    try {
      ...
      assertEquals(1.02, oState.m_fClimateChangeTempB.getValue(), 0.0001);
      assertEquals(2, oState.m_fClimateChangeTempC.getValue(), 0.0001);
      assertEquals(10, oState.m_fClimateChangeMinTemp.getValue(), 0.0001);
      assertEquals(110, oState.m_fClimateChangeMaxTemp.getValue(), 0.0001);
  ...
  private String writeValidXMLFile() throws java.io.IOException {
    ...
    oOut.write("<sc_climateChangeTempB>1.02</sc_climateChangeTempB>");
    oOut.write("<sc_climateChangeTempC>2</sc_climateChangeTempC>");
    oOut.write("<sc_climateChangeMinTemp>10</sc_climateChangeMinTemp>");
    oOut.write("<sc_climateChangeMaxTemp>110</sc_climateChangeMaxTemp>");
    oOut.write("</ClimateChange1>");
