...
public class LightFilterTest extends TestCase {
  ...
  public void testReadV6ParFile() {
    ...
    try {
      ...
      ArrayList<Behavior> p_oBehs = oLightBeh.getBehaviorByParameterFileTag("LightFilter");
      assertEquals(1, p_oBehs.size());
      LightFilter oLight = (LightFilter) p_oBehs.get(0);

      assertEquals(2.535, oLight.m_fFilterLightTransmissionCoefficient.getValue(), 0.0001);
      assertEquals(2.3, oLight.m_fFilterHeight.getValue(), 0.0001);    
    }
  ...
  public void testReadParFile() {
    ...
    try {
      ...
      assertEquals(1.535, oLight.m_fFilterLightTransmissionCoefficient.getValue(), 0.0001);
      assertEquals(1.3, oLight.m_fFilterHeight.getValue(), 0.0001);
  ...
  private String writeValidXMLFile() throws java.io.IOException {
    ...
    oOut.write("<li_lecVal species=\"Species_2\">0.091</li_lecVal>");
    oOut.write("<li_lecVal species=\"Species_3\">0.059</li_lecVal>");
    oOut.write("</li_lightExtinctionCoefficient>");
    oOut.write("</GeneralLight>");
  ...
  private String write6XMLValidFile() throws IOException {
    ...
    oOut.write("<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"no\" ?>"); oOut.write("<paramFile fileCode=\"06010101\">");
    oOut.write("<plot>");
    oOut.write("<timesteps>1</timesteps>");
    oOut.write("<yearsPerTimestep>2</yearsPerTimestep>");
    oOut.write("<randomSeed>1</randomSeed>");
    ...
    oOut.write("<lf_lightExtinctionCoefficient>2.535</lf_lightExtinctionCoefficient>");
    oOut.write("<lf_heightOfFilter>2.3</lf_heightOfFilter>"); 
    oOut.write("</lightFilter>"); 
    oOut.write("</paramFile>");
