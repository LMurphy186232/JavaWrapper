...
public class TestConstantGLI extends ModelTestCase {
  ...
  public void testReadV6ParFile() {
    ...
    try {
      ...
      ArrayList<Behavior> p_oBehs = oLightBeh.getBehaviorByParameterFileTag("ConstantGLI");
      assertEquals(1, p_oBehs.size());
      ConstantGLI oLight = (ConstantGLI) p_oBehs.get(0);

      assertEquals(22.5, oLight.m_fConstantGLIValue.getValue(), 0.001);    
    }
  ...
  public void testReadParFile() {
    ...
    try {
      ...
      for (Behavior oBeh : oLightBeh.getAllInstantiatedBehaviors()) 
        if (oBeh instanceof ConstantGLI) oLight = (ConstantGLI)oBeh;
      assertEquals(12.5, oLight.m_fConstantGLIValue.getValue(), 0.001); 
  ...
  public void testValidateData() {
    ...
    //Case:  constant GLI is not between 0 and 100.
    oLight.m_fConstantGLIValue.setValue( -10);
    try {
      oLightBeh.validateData(oPop);
      fail("Light validation failed - Case: constant GLI is not between 0 and 100.");
    }
    catch (ModelException oErr) {
      ;
    }
  ...
  private String write6XMLValidFile() throws IOException {
    ...
    oOut.write("<li_constGLI>22.5</li_constGLI>");
    oOut.write("</lightOther>");
    oOut.write("</paramFile>");
